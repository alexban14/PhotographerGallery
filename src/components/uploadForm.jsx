...
const UploadForm = () => {
	...
	return (
		<div className="p-2 mt-6 mb- mx-auto">
			...
			<div className="relative z-0 w-full mb-6 group">
				<input onChange={changeFile} type="file"id="image" className="mt-8 block py-2.5 px-0 w-full text-gray-900 border-0 border-b-2 border-gray-300 dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"/>
